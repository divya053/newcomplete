// logo.tsx — Preckon brand mark & lockup (framework primitive, guardrail #8).
// -----------------------------------------------------------------------------
// The canonical brand mark. The wordmark expects the General Sans font exposed
// as --font-display (system fallback included).
//
// Design rule: teal lives on the reckoning point ONLY — the node and the "o".
// Everything else uses currentColor, so the logo adapts to light/dark simply by
// setting the surrounding text color.
// -----------------------------------------------------------------------------

import * as React from "react";

/** Intelligence teal — the reckoning-point accent (token: --color-primary). */
